...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    cart: "Your Cart",
    account: "Account",
    checkoutNeedsAccount: "Sign in with Shopify to prefill checkout and see your orders.",
    checkoutReady: "Shopify account connected. Checkout will recognize you.",
    checkout: "Checkout",
    total: "Total",
  ...
  ar: {
    ...
    cart: "السلة",
    account: "الحساب",
    checkoutNeedsAccount: "سجّل دخولك عبر Shopify لتعبئة الدفع تلقائيًا وعرض طلباتك.",
    checkoutReady: "حساب Shopify متصل. سيتعرف عليك الدفع تلقائيًا.",
